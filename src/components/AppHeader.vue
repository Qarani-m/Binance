        ...
        <div class="space-y-6">
          ...
          <div class="pt-4 border-t border-[#2b3139] space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6">
              ...
              <router-link to="/vip" @click="closeMobileMenu"
                class="text-white font-medium text-[16px]">VIP</router-link>
          ...
          <template v-else>
            <div class="p-4 bg-[#1e2329] rounded-lg">
              <div class="flex items-center gap-3 mb-4">
                <div
                  class="w-10 h-10 rounded-full bg-[#2b3139] flex items-center justify-center text-primary font-bold">
