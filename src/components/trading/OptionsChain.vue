...
<template>
    <div class="flex-1 overflow-hidden flex flex-col bg-[#0B0E11] select-none text-[12px]">
        ...
        <div class="h-10 border-b border-[#2B3139] flex items-center bg-[#1A1D29] flex-none">
            ...
            <div
                class="flex-[0.8] md:flex-[0.6] flex flex-col items-center justify-center leading-tight py-1 bg-[#0B0E11]/50 h-full border-x border-[#2B3139]">
                <div class="hidden md:block text-[#848E9C] text-[10px]">BTCUSDT Price: <span
                        class="text-[#0ECB81]">90,653.671</span>
